...
/* Exemple d'utilisation de la libmesh5 : transformation de quadrangles en triangles dans un maillage surfacique */
...
int main()
{
	...
	if(!(OutMsh = GmfOpenMesh("tri.mesh", GmfWrite, 3, dim)))
		return(1);
